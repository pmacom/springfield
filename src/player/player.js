...
//var defaultArgs = [ '-idle', '-slave', '-fs', '-noborder', '-framedrop'];
var defaultArgs = [ '-idle', '-slave' ]
...
Player.prototype = _.extend({
    spawn: function() {
        ...
        console.log( 'ARGS:', args, defaultArgs.concat(args) );
        var instance = spawn('mplayer', defaultArgs.concat(args), { env: env });
    ...
    setStatus: function(status) {
        ...
        console.log('333333333333333333333333333333333333333333', this.status);
